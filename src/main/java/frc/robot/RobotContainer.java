...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    //requires operator controller to have already been defined (see original code)
    //have students decide which button to bind to to which command
    // Operator Controller example:
// A button -> lower arm
m_operatorController.a().whileTrue(m_arm.lowerArmCommand());

// B button -> raise arm
m_operatorController.b().whileTrue(m_arm.raiseArmCommand());
  }
